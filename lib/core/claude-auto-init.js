 ...
 * Automatically runs when Claude starts working on a project
...
function displayDashboard() {
  ...
  console.log(`Tests: ${chalk.gray('Run npm test to check')}`);
  console.log(`Build: ${chalk.gray('Run npm run build to check')}`);
